        ...
        <div class="main-wrapper">
            ...
            <div class="header">
				...
				<div class="top-nav-search">
					<form method="POST" action="add_programmes.php">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-7 col-auto">
								<h3 class="page-title">Degree Programme</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="home.php">Dashboard</a></li>
									<li class="breadcrumb-item active">Degree Programme</li>
								</ul>
							</div>
							<div class="col-sm-5 col">
								<a href="#Add_Persons" data-toggle="modal" class="btn btn-success float-right mt-2"> <i class="fa fa-plus-square" aria-hidden="true"></i> Add Degree Programme</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
											...
											<tbody>
												...
												<?php
													...
													if(ISSET($_POST['search1']))
													{
														...
														if($prm1 == null)
														{
															$z = $conn->query("SELECT * FROM degree ORDER BY degID ASC") or die ($conn->error());
														}
														else
														{
															$z = $conn->query("SELECT * FROM degree WHERE degID = '$prm1' OR degName = '$prm1' ORDER BY degID ASC") or die ($conn->error());
														}
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Add Degree Programme</h5>
								...
								<div class="row form-row">
									...
									<div class="col-12">
										<div class="form-group">
											...
											<input type="text" name="degID" class="form-control" required="">
										</div>
									</div>
									...
									<div class="col-12">
										<div class="form-group">
											...
											<input type="text" name="degName" class="form-control" required="">
										</div>
									</div>

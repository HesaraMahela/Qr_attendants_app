...
<head>
        ...
        <title>Attendance Mananagement System - Batch</title>
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						 <?php
                    			...
                    			$query1 = mysqli_query($conn, "SELECT * FROM batch WHERE `batchNo` = '$batchNo'") or die(mysqli_error());
...
<h5 class="page-title" style="margin-top:10px; margin-left:25%; margin-bottom:50px; width:50%;">
	<div class="row form-row">
		...
		<div class="col-12">
				...
				<center><h4 class="page-title" style="margin-top:150px; width:100%; margin-bottom:25px;"><?php echo $fetch1['batchNo']; ?></h4></center>
				<center><h4 class="page-title" style="width:100%; margin-bottom:50px;"><?php echo $fetch1['year']; ?></h4></center>
		</div>
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Edit Batch Details</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<div class="modal-body">
							<form method="POST" action="new_batch.php" enctype="multipart/form-data">
								<div class="row form-row">

								<div class="col-12">
										<div class="form-group">
											<label>Intake Description</label>
											<input style="display:none;" type="text" name="batchNo" class="form-control" required="" readonly="true" value="<?php echo $fetch1['batchNo']; ?>">
											<input type="text" name="year" class="form-control" required="" value="<?php echo $fetch1['year']; ?>">
										</div>
									</div>

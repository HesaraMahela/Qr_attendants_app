					...
					<div class="page-header">
						<div class="row">
							...
							<div class="col-sm-5 col">
								<a href="#Add_Persons" data-toggle="modal" class="btn btn-success float-right mt-2"> <i class="fa fa-plus-square" aria-hidden="true"></i> Add Modules</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
											...
											<tbody>
												...
												<?php
													...
													if(ISSET($_POST['search1']))
													{
														...
														if($prm1 == null)
														{
															$z = $conn->query("SELECT * FROM module ORDER BY m_code ASC") or die ($conn->error());
														}
														else
														{
															$z = $conn->query("SELECT * FROM module WHERE m_code = '$prm1' OR m_name = '$prm1' ORDER BY m_code ASC") or die ($conn->error());
														}
													...
													<td class="text-center">
														<h2 class="table-avatar">
															<textarea class="form-control" rows="4" cols="70" readonly="true"><?php echo $row['description']; ?></textarea>
														</h2>
													</td>
												
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" href="mo_edit.php?m_code=<?php echo $row['m_code']; ?>">
								...
								<div class="row form-row">
									...
									<div class="col-12">
										<div class="form-group">
											...
											<textarea id="my-text" name="description" class="form-control" rows="4" placeholder="Enter Module Description . . ."></textarea>

					...
					<div class="page-header">
						<div class="row">
							...
							<div class="col-sm-5 col">
								<a href="#Add_Persons" data-toggle="modal" class="btn btn-success float-right mt-2"> <i class="fa fa-plus-square" aria-hidden="true"></i> Add Batch</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
										...
										<table class="datatable table table-hover table-center mb-0">
											<thead>
												<tr>
													...
													<th class="text-left">Intake Description</th>
											...
											<tbody>
												...
												<?php
													...
													if(ISSET($_POST['search1']))
													{
														...
														if($prm1 == null)
														{
															$z = $conn->query("SELECT * FROM batch ORDER BY batchNo ASC") or die ($conn->error());
														}
														else
														{
															$z = $conn->query("SELECT * FROM batch WHERE batchNo = '$prm1' ORDER BY batchNo ASC") or die ($conn->error());
														}
													...
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" href="bt_edit.php?batchNo=<?php echo $row['batchNo']; ?>">

				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						?>
							...
							<div class="row">
								<div class="col-md-12">
									<h4 class="mb-4">List of Completed Lectures</h4>
										<div class="appointment-tab">

											<div class="tab-content">

												<!-- Todays Lectures Tab -->
												<div class="tab-pane show active" id="today-lectures">
															...
															<div class="table-responsive">
																...
																<?php
																	...
																	if(ISSET($_POST['search']))
																	{
																		...
																		if($prm1 == null)
																		{
																			$z = $conn->query("SELECT * FROM lecture INNER JOIN module on lecture.m_code = module.m_code WHERE lecture.m_code = '$m_code' AND ins_id = '$ins_id' AND cast(lecture.s_time as date) < CURRENT_DATE ORDER BY lec_id ASC") or die ($conn->error());
																		}
																		else
																		{
																			$z = $conn->query("SELECT * FROM lecture INNER JOIN module on lecture.m_code = module.m_code WHERE lecture.m_code = '$m_code' AND ins_id = '$ins_id' AND cast(lecture.s_time as date) < CURRENT_DATE AND lecture.s_time = '$prm1' ORDER BY lec_id ASC") or die ($conn->error());
																		}

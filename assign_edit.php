                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						 <?php
                    			...
                    			$query1 = mysqli_query($conn, "SELECT * FROM enrollment WHERE batchNo = '$batchNo' AND degID = '$degID' AND m_code = '$m_code' ORDER BY batchNo ASC") or die(mysqli_error());
		...
		<div class="col-12">
				<h4 class="table-avatar" style="margin-top:50px; width:50%; margin-bottom:50px;">
						...
						<?php 
							...
							$module = $fetch1['m_code'];
							$degree = $fetch1['degID']; 
							$z2 = $conn->query("SELECT * FROM degree WHERE degID = '$degree'") or die ($conn->error());
							$z3 = $conn->query("SELECT * FROM module WHERE m_code = '$m_code'") or die ($conn->error());
							$fetch2 = mysqli_fetch_array($z2);
							$fetch3 = mysqli_fetch_array($z3);
						?>

				<center>
					<h4 class="page-title" style="margin-top:150px; width:100%; margin-bottom:25px;"><?php echo $fetch1['degID']; ?> | <?php echo $fetch2['degName']; ?></h4></center>
				<center><h4 class="page-title" style="width:100%; margin-bottom:50px;"><?php echo $fetch1['m_code']; ?> | <?php echo $fetch3['m_name']; ?></h4></center>
		</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								<h4 class="modal-title">Delete Assign Module</h4>
								<p class="mb-4">Are you sure want to delete ?</p>

								<form method="POST" action="new_assign.php" enctype="multipart/form-data">
									<input style="display: none;" type="text" name="batchNo" value="<?php echo $fetch1['batchNo']; ?>">
									<input style="display: none;" type="text" name="degID" value="<?php echo $fetch2['degID']; ?>">
									<input style="display: none;" type="text" name="m_code" value="<?php echo $fetch3['m_code']; ?>">
